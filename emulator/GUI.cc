...
static void createDeviceObjects()
{
    ...
    g_VertHandle = create_shader(GL_VERTEX_SHADER, vertex_shader, sizeof(vertex_shader));
    g_FragHandle = create_shader(GL_FRAGMENT_SHADER, fragment_shader, sizeof(fragment_shader));
    g_ShaderHandle = link_program(g_VertHandle, g_FragHandle);
