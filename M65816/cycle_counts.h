/**
 * Per-opcode cycle counts for all five possible CPU operating modes
 * Opcodes >255 are internal only opcodes for states such as interrupt
 * handling.
 */

static const unsigned int cycle_counts_e0m0x0[259] = {
...
static const unsigned int cycle_counts_e0m0x1[259] = {
    8, 7, 8, 5, 7, 4, 7, 7, 3, 3, 2, 4, 8, 5, 8, 6,
...
static const unsigned  int cycle_counts_e0m1x0[259] = {
...
static const unsigned  int cycle_counts_e0m1x1[259] = {
    8, 6, 8, 4, 5, 3, 5, 6, 3, 2, 2, 4, 6, 4, 6, 5,
...
static const unsigned int cycle_counts_e1m1x1[259] = {
    8, 6, 8, 4, 5, 3, 5, 6, 3, 2, 2, 4, 6, 4, 6, 5,
    2, 5, 5, 7, 5, 4, 6, 6, 2, 4, 2, 2, 6, 4, 7, 5,
    6, 6, 8, 4, 3, 3, 5, 6, 4, 2, 2, 5, 4, 4, 6, 5,
    2, 5, 5, 7, 4, 4, 6, 6, 2, 4, 2, 2, 4, 4, 7, 5,
